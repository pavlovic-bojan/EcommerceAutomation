...
public class SauceDemoLoginPage extends BasePage {
    ...
    public void enterUsername(String username) throws Exception {
        typeText(usernameInput, username, "Usarname " + username + " has been typed into the field!");
    }

    public void enterPassword(String password) throws Exception {
        typeText(passwordInput, password, "Usarname " + password + " has been typed into the field!");
    }
